...
<body style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
    ...
    <!-- 1st section -->
    <div style="width: 80%; justify-self: center; background-color: white; position: relative; top: 15vh;">
        <h1>Returns Policy</h1>
        <br>
        <br>
        <div style="display: flex;">
            <p>Home -</p>
            <h4 style="bottom: 5px; left: 3px; position: relative;">Returns Policy</h4>
            <br>
            <br>
        </div>
        <div>
            <p>RolsaTech Web Customer Returns</p>
            <p>We offer a 14 day returns policy for which to return your item to us for a refund, from the date the item was received. The item must be in pristine condition and come complete with the original undamaged packaging. The cost to return must be covered and organised by the customer.</p>
        </div>
        <br>
        <hr style="border: 2px solid #75fb87; opacity: 100%;">
        <br>
        <br>
        <div>
