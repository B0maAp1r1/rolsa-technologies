...
<body>
    ...
    <div style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; height: 100px; position: relative; top: 250px; justify-self: center;">
        <h1>Terms and Conditions</h1>
        <br>
        <p>Home - <strong>Terms and Conditions</strong></p>
    </div>

    <div style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; height: 300px; position: relative; top: 350px; justify-self: center;">
        <p>The terms and conditions for the various myenergi applications and services, and our other legal and warranty information is available using the following links:</p>
        <p><a style="color: black; text-decoration: underline; opacity: 75%;" href="">Online term of use and supply</a></p>
        <p><a style="color: black; text-decoration: underline; opacity: 75%;" href="">Privacy Policy</a></p>
        <p><a style="color: black; text-decoration: underline; opacity: 75%;" href="">Product Warranty</a></p>
        <p>Environmental, H&S & Quality Policies available on request at <u>ireland.info@rolsatech.com.</u></p>
        <p>We will take back your product when it reaches end of life, free of charge. Please contact us for details <br> <u>ireland.info@rolsatech.com</u>.</p>
    </div>
